export function Game({ className, stroke }) {
  return (
    <svg
      className={className}
      ...
      fill="none"
    >
      <rect x="13" y="14" width="2" height="2" rx="1" fill={stroke} />
      <path d="M10 14H6" stroke={stroke} strokeLinecap="round" />
      <path d="M8 12L8 16" stroke={stroke} strokeLinecap="round" />
      <rect x="16" y="12" width="2" height="2" rx="1" fill={stroke} />
      <path
